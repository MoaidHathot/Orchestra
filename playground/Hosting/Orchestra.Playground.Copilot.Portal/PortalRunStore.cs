...
/// <summary>
/// Enhanced file-system backed run store for Portal.
/// Layout:
...
/// </summary>
public class PortalRunStore : IRunStore
{
	...
	public PortalRunStore(string rootPath)
	{
	...
	/// </summary>
	/// <param name="record">The run record to save.</param>
	/// <param name="orchestration">The orchestration definition (for copying).</param>
