...
export const Icons = {
  ...
  Power: (): React.JSX.Element => (
    <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor">
      <path d="M7.25 1a.75.75 0 0 1 1.5 0v5a.75.75 0 0 1-1.5 0V1ZM4.114 3.367a.75.75 0 0 1-.248 1.032A5.517 5.517 0 0 0 2.5 8.5a5.5 5.5 0 1 0 11 0 5.517 5.517 0 0 0-1.366-4.101.75.75 0 1 1 1.284-.784A6.987 6.987 0 0 1 15 8.5a7 7 0 1 1-14 0A6.987 6.987 0 0 1 3.083 3.12a.75.75 0 0 1 1.031.248Z" />
    </svg>
  ),
  Pencil: (): React.JSX.Element => (
    <svg width="12" height="12" viewBox="0 0 16 16" fill="currentColor">
      <path d="M11.013 1.427a1.75 1.75 0 0 1 2.474 0l1.086 1.086a1.75 1.75 0 0 1 0 2.474l-8.61 8.61c-.21.21-.47.364-.756.445l-3.251.93a.75.75 0 0 1-.927-.928l.929-3.25c.081-.286.235-.547.445-.758l8.61-8.61Zm.176 4.823L9.75 4.81l-6.286 6.287a.253.253 0 0 0-.064.108l-.558 1.953 1.953-.558a.253.253 0 0 0 .108-.064Zm1.238-3.763a.25.25 0 0 0-.354 0L10.81 3.75l1.44 1.44 1.263-1.263a.25.25 0 0 0 0-.354Z" />
    </svg>
  ),
