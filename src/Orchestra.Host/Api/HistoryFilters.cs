...
public sealed record HistoryFilters
{
	...
	public bool HasAnyFilter => Origins is not null || Roots is not null || Statuses is not null;
}
...
{
	/// <summary>
	/// Parses the <c>?origins=</c>, <c>?roots=</c>, and <c>?statuses=</c> query parameters
	/// into a <see cref="HistoryFilters"/> value.
	/// </summary>
	/// <remarks>
	...
	/// </remarks>
	public static HistoryFilters Parse(string? origins, bool? roots, string? statuses)
	{
	...
	/// </summary>
	public static bool Matches(ActiveExecutionInfo info, HistoryFilters filters)
	{
	...
	/// </summary>
	public static bool Matches(RunIndex index, HistoryFilters filters)
	{
		if (filters.Origins is { } origins)
		{
